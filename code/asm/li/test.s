...
# 
#   If the immediate value is in the range iof -2,048 .. +2,047, then it can
#   be assembled identicaly to:
# 
#   ADDI RD, x0, IMM
#   
#   If the immediate value is not within th range of -2,048 .. +2,047 but
#   is within the range of a 32-bit number (i.e., -2,147,483,648 .. +2,147,483,647)
#   then it can be assembled using this tw-instruction sequence:
# 
#   LUI RD, Upper-20
#   ADDI RD, RD, Lower-12
# 
